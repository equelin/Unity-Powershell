Function Get-UnitymgmtInterfaceSettings {
  ...
  <#
      .SYNOPSIS
      Global settings for mgmtInterfaces.  
      .DESCRIPTION
      Global settings for mgmtInterfaces.  
  ...
  Param (
    ...
    [Parameter(Mandatory = $false,ParameterSetName='ID',ValueFromPipeline=$True,ValueFromPipelinebyPropertyName=$True,HelpMessage = 'UnitymgmtInterfaceSettings ID')]
    [String[]]$ID
  )
  ...
  Begin {
    ...
    $URI = '/api/types/mgmtInterfaceSettings/instances' #URI
