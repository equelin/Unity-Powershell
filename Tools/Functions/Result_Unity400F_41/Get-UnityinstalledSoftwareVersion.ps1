Function Get-UnityinstalledSoftwareVersion {
  ...
  Param (
    ...
    [Parameter(Mandatory = $false,ParameterSetName='ID',ValueFromPipeline=$True,ValueFromPipelinebyPropertyName=$True,HelpMessage = 'UnityinstalledSoftwareVersion ID')]
    [String[]]$ID
  )
  ...
  Begin {
    ...
    $URI = '/api/types/installedSoftwareVersion/instances' #URI
    $TypeName = 'UnityinstalledSoftwareVersion'
  }
