Function Get-UnityfcPort {
  ...
  Param (
    ...
    [Parameter(Mandatory = $false,ParameterSetName='Name',ValueFromPipeline=$True,ValueFromPipelinebyPropertyName=$True,HelpMessage = 'UnityfcPort Name')]
    [String[]]$Name,
    [Parameter(Mandatory = $false,ParameterSetName='ID',ValueFromPipeline=$True,ValueFromPipelinebyPropertyName=$True,HelpMessage = 'UnityfcPort ID')]
    [String[]]$ID
  )
  ...
  Begin {
    ...
    $URI = '/api/types/fcPort/instances' #URI
    $TypeName = 'UnityfcPort'
  }
