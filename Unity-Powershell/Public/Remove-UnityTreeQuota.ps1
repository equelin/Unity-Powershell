Function Remove-UnityTreeQuota {
  ...
  <#
      ...
      .EXAMPLE
      Remove-UnityTreeQuota -ID 'treequota_12345_1'

      Delete the treeQouta with ID 'treequota_12345_1'
      .EXAMPLE
      Get-UnityTreeQuota -ID 'treequota_12345_1' | Remove-UnityTreeQuota

      Delete the treeQuota with ID 'treequota_12345_1'. The treeQouta's information are provided by the Get-UnityTreeQuota through the pipeline.
  #>
  ...
  Begin {
    ...
    # Variables
    $URI = '/api/instances/treeQuota/<id>'
    $Type = 'treeQuota'
